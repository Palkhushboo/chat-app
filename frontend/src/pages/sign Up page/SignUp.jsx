  ...
  return (
    <div className='flex flex-col items-center justify-center min-w-96 mx-auto'>
      ...
      <form>
        ...
        <input type="text" 
        placeholder='John deo'className='w-full  input input-bordered h-10'/>
        </div>
        ...
        <input type="password" placeholder='Confirmed password'className='w-full  input input-bordered h-10'/>
